...
* **Google Tag Manager & Analytics:** Manter as tags oficiais instaladas em todas as páginas públicas:
  * GTM Container ID: `GTM-KPL6PVKC` no `<head>` e `<noscript>` logo após `<body>`
  * GA4 ID da métrica: `G-GMK24ECXMF`
  * GA4 Código do fluxo: `15812853732`
